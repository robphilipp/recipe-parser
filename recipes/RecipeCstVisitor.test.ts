...
1 egg`
        ...
        expect(recipe).toEqual({
            type: "ingredients",
            ingredients: [
                {amount: {quantity: 1.5, unit: UnitType.CUP}, ingredient: 'all-purpose flour', section: 'dough'},
                {amount: {quantity: 1, unit: UnitType.TEASPOON}, ingredient: 'vanilla extract', section: 'dough'},
                {amount: {quantity: 1, unit: UnitType.CUP}, ingredient: 'milk', section: 'sauce'},
                {amount: {quantity: 1, unit: UnitType.PIECE}, ingredient: 'egg', section: 'sauce'},
            ]})
        expect(errors).toHaveLength(1)
        expect(errors[0]).toEqual({
            offset: 56,
